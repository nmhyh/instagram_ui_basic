                    ...
                    child: Column(
                      ...
                      children: [
                          ...
                          child: TextField(
                            ...
                            decoration: InputDecoration(
                              ...
                              enabledBorder: OutlineInputBorder(
                                borderSide: const BorderSide(width: 3, color: DarkTheme.textDisable),
                                borderRadius: BorderRadius.circular(5),
                              ),
                              focusedBorder: OutlineInputBorder(
                                borderSide: const BorderSide(width: 3, color: DarkTheme.blueMain),
                                borderRadius: BorderRadius.circular(5),
                              )
                            ),
                          ),
                        ...
                        Container(
                          ...
                          margin: const EdgeInsets.only(top: 7, bottom: 30, right: 34),
                          child: Text(
                            'Forgot password?',
                            style: TxtStyle.headingCardContent.copyWith(color: DarkTheme.blueMain),
                          ),
                        ),
                        Padding(
                        ...
                        Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Text('Switch accounts', style: TxtStyle.headingCardFontWeightBold.copyWith(color: DarkTheme.blueMain),)
                            ],
                          )
                        ),
                        Container(
                            ...
                            children: [
                              ...
                              Expanded(
                                ...
                                child: Container(
                                  ...
                                  child: Text(
                                    'OR',
                                    style: TxtStyle.headingCardContent.copyWith(color: DarkTheme.textDisable),
                                  ),
                                ),
                              ),
                              Expanded(
                          ...
                          child: RichText(
                            text: TextSpan(
                              ...
                              children: [
                                TextSpan(
                                  text: 'Sign up',
                                  style: TxtStyle.headingCardFontWeightBold.copyWith(color: DarkTheme.blueMain),
                                )
                              ]
                            ),
                          ),
